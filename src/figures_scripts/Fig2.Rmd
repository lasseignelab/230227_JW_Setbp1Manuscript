...
kd <- DotPlot(kidney_int_celltypes,
  ...
  theme(axis.title.x = element_blank()) +
  theme(panel.grid = element_blank()) +
  theme(axis.text.x = element_text(face = "bold" ,angle = 90, hjust = 0.5, vjust = 0.5)) +
  coord_flip()
kd
...
# SUPP_cortex_markers <- (cp / cd) + theme_bw() + plot_layout(ncol = 1, heights = c(1,5))
# SUPP_cortex_markers
# 
# png(filename = here("results/figures/SUPP_cortex_markers.png"))
#     SUPP_cortex_markers
# dev.off()
```
