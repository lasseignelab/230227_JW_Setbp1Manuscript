...
#SBATCH --array=0-3 #4 expression matrix inputs (2 kidney and 2 cortex, one from each condition)
...
src="/data/user/jbarham3/230227_JW_Setbp1Manuscript/src/network_scripts/decoupleR_PANDA" #be sure that your subdirectories are structured the same
...
SAMPLE_LIST="${wd}/results/array_inputs/Setbp1_decoupleR_PANDA_files_array.txt" #note: make sure path and file name are correct
