...
save(ctrl_enriched, file = here("results/diff_targeting/cortex_ctrl_enriched_gene_across.Rdata"))
```
...
meta_colname <- "cell_type"
# setting plot path
plot_path <- here("results/diff_targeting/cortex_gene_DIFFtargeting_across_het_enriched_heatmap.png")
# setting rowtitle
rowtitle <- "genes"
# setting columntitle
...
for (i in cell_names) {
  if (i == "mural") {
    ...
    plot <- bubbleplot(fea_result_filt) +
      ggtitle(paste0("Non-sig Pathways Associated with Differentially Targeted genes (Setbp1 or known targets) across cell-types in Setbp1 S858R ", i)) +
...
[1] "nonsig pathways investigated and plotted in mural"
...
for (i in cell_names) {
  if (i == "microglia" || i == "oligodendrocytes") {
    top <- data[data$cell_type == i, ]
    genes <- as.character(top$gene)
    # submit genes to pathway analysis function ----------
    fea_result_filt <- fea_no_sig(genes = genes, organism = "mmusculus", max_term = 1000, min_term = 1)
...
[1] "pathways investigated and plotted in fibro_cortex"
[1] "pathways investigated and plotted in inhibitory_neurons"
[1] "non-sig pathways investigated and plotted in microglia"
[1] "pathways investigated and plotted in mural"
[1] "non-sig pathways investigated and plotted in oligodendrocytes"
[1] "pathways investigated and plotted in opcs"
...
```
[1] "nonsig pathways investigated and plotted in astrocytes"
[1] "pathways investigated and plotted in excitatory_neurons"
[1] "pathways investigated and plotted in fibro_cortex"
[1] "pathways investigated and plotted in inhibitory_neurons"
[1] "pathways investigated and plotted in microglia"
...
[181] openssl_2.0.5               survival_3.3-1              repr_1.1.6                  desc_1.4.2                  munsell_0.5.0              
[186] GetoptLong_1.0.5            rhdf5_2.38.1                GenomeInfoDbData_1.2.7      iterators_1.0.14            RCy3_2.14.2                
[191] HDF5Array_1.22.1            reshape2_1.4.4              gtable_0.3.1   
