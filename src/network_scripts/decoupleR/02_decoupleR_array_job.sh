...
#SBATCH --job-name=cor_decoupleR #Note: when running kidney this needs to be changed to 'kid_decoupleR' from 'cor_decoupleR'
...
#SBATCH --nodes=1
#SBATCH --time=24:00:00 #Note: '24:00:00 hours for brain, when running kidney this needs to be changed to 5 days as '120:00:00'
#SBATCH --partition=largemem-long #partition info here: https://docs.rc.uab.edu/cheaha/hardware/#partitions
#
#SBATCH --output=%x_%A_%a.out
#SBATCH --error=%x_%A_%a.err
#SBATCH --array=0-15 #Note: when running kidney this needs to be changed to 0-33 from 0-15 for brain; 16 dfs in list for cortex and 34 for kidney
...
RDATA_FILE=${wd}/data/processed/decoupleR_expression_inputs/cerebral_expression.Rdata # NOTE: be sure to swap out 'cerebral_expression' for 'kidney_expression', or other tissue of interest and resubmit this same job
