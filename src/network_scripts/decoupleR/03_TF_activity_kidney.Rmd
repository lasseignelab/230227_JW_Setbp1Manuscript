...
summary(merged_df$percent_change) # Q3 is at 35.1
merged_df <- merged_df[merged_df$percent_change > 35.1, ]
...
png(
  filename = here("results/TF_activity/kidney_setbp1_geneset.png"),
  width = 1100,
  height = 1100,
  res = 250
)
