...
names(geneset_acts_mat_pos)[16] <- non_pos
...
## plot positive
png(
  filename = here("results/TF_activity/cortex_setbp1_geneset_pos.png"),
  width = 900,
  height = 1000,
  res = 250
)
...
## plot negative
png(
  filename = here("results/TF_activity/cortex_setbp1_geneset_neg.png"),
  width = 900,
  height = 1000,
  res = 250
)
