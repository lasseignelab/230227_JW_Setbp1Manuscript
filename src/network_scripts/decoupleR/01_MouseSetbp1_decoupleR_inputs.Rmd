---
title: "02_MouseSetbp1_decoupleR_inputs"
author: "Jordan Whitlock"
date: '2023-05-12'
output: html_document
---
NOTE TO REVIEWER: THIS WAS RUN IN 1.0.6 VERSION OF DOCKER (PLEASE REMOVE THIS AFTER YOU ARE SECOND CODE REVIEWER OR LEAVE A COMMENT FOR ME TO DO SO)
...
# constructing expression input for decoupleR analysis
```{r}
...
for (i in levels(cerebral_int_celltypes)) {
  ...
  decoupleR_expression <- cerebral_decoupleR_expression
}

save(decoupleR_expression,
...
for (i in levels(kidney_int_celltypes)) {
  ...
  decoupleR_expression <- kidney_decoupleR_expression
}
...
# constructing prior network for decoupleR analysis

The prior network for decoupleR was constructed using CollecTRI (https://github.com/saezlab/CollecTRI) for mouse on 230525. The file is located in this github repository as `mouse_prior_tri.csv`
