...
* Generating PPI Input for Human:
  * STRING:
    ...
    * Then the species.index must be specified, here I use the mouse NCBI taxon-id (human - 9606; https://string-db.org/cgi/organisms, mouse -10090; https://string-db.org/cgi/organisms).
...
These inputs were generated in the HumanMouse_TF_motif_enrichment.Rmd
```{r}
hu_motif_all <- read.table(here("data/processed/motif_inputs/hu_motif_all.txt"),
  sep = "\t")
```
