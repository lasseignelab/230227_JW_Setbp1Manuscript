...
setbp1ELISA_data$sample_ID <- c("standard", "standard", "standard", "standard",
...
# wrangle and format concentrations
sample_ID <- c("cortex_het", "cortex_het", "cortex_het", "cortex_wt",
...
ggplot(data = rep_conc_ELISA, aes(
  ...
  scale_fill_manual(values = c("kidney_wt" = "#FE6100",
                               "kidney_het" = "#FFB000",
                               "cortex_het" = "#5F9EFD",
                               "cortex_wt" = "#644DD4"))
dev.off()
...
setbp1BCA_data$sample_ID <- c("standard", "standard", "standard", "standard",
...
ggplot(concentrations_ug_mL, aes(y = Setbp1_percent, x = sample_ID, fill = sample_ID)) +
  ...
  theme_bw() +
  geom_signif(
    comparisons = list(c("cerebral cortex WT", "cerebral cortex het"),
...
my_comparisons <- list(c("cortex_het", "cortex_wt"),
