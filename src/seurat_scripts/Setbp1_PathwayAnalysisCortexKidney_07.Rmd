...
```{r}
cortex_list <- list(inhibitory_neurons = inhibitory_neurons_het,
...
kidney_list <- list(bcell = bcell_het,
                    CDPC = CDPC_het,
                    CDICA = CDICA_het,
                    CDICB = CDICB_het,
                    DCT = DCT_het,
                    ...
                    podocytes = podo_het,
                    PST = PST_het,
                    smooth_muscle_cells = smcs = smcs_het,
...
for (i in cell_types) {
  ...
  print(plot)
  dev.off()
  } else(print(paste("no DE targets in", i))) # none in mural_cells
  }
```
