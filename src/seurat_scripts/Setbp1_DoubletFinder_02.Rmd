...
load(here("data/split_sample_kidney.Rdata"))
```
...
doublet_removal(sample = split_sample$K3, expected = 0.086, pK = 0.1) #pK obtained from plot in line above
split_sample$K3 <- no_doublets

#K4
define_pK(split_sample$K4)
doublet_removal(sample = split_sample$K4, expected = 0.088, pK = 0.1) #pK obtained from plot in line above
split_sample$K4 <- no_doublets

#K5
define_pK(split_sample$K5)
doublet_removal(sample = split_sample$K5, expected = 0.106, pK = 0.1) #pK obtained from plot in line above
split_sample$K5 <- no_doublets

#K6
define_pK(split_sample$K6)
doublet_removal(sample = split_sample$K6, expected = 0.097, pK = 0.1) #pK obtained from plot in line above
...
load(here("data/split_sample_cortex.Rdata"))
```
...
doublet_removal(sample = split_sample$J1, expected = 0.04, pK = 0.1) #pK obtained from plot in line above

#J2
define_pK(split_sample$J2)
doublet_removal(sample = split_sample$J2, expected = 0.054, pK = 0.1) #pK obtained from plot in line above

#J3
define_pK(split_sample$J3)
doublet_removal(sample = split_sample$J3, expected = 0.078, pK = 0.1) #pK obtained from plot in line above

#J4
define_pK(split_sample$J4)
doublet_removal(sample = split_sample$J4, expected = 0.079, pK = 0.1) #pK obtained from plot in line above

#J13
define_pK(split_sample$J13)
doublet_removal(sample = split_sample$J13, expected = 0.071, pK = 0.1) #pK obtained from plot in line above

#J15
define_pK(split_sample$J15)
doublet_removal(sample = split_sample$J15, expected = 0.067, pK = 0.1) #pK obtained from plot in line above
```
