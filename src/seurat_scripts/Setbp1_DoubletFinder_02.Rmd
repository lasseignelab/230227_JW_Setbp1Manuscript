...
pdf(here("results/seurat/DoubletFinder_02/doubletsremoved_kidney.pdf"))
...
pdf(here("results/seurat/DoubletFinder_02/definepK_cortex.pdf"))
...
pdf(here("results/seurat/DoubletFinder_02/doubletsremoved_cortex.pdf"))
#J1
...
#J2
doublet_removal_noapprox(sample = split_sample$J2, expected = 0.054, pK = 0.27) #pK obtained from plot in line above
split_sample$J2 <- no_doublets

#J3
doublet_removal_noapprox(sample = split_sample$J3, expected = 0.078, pK = 0.18) #pK obtained from plot in line above
split_sample$J3 <- no_doublets

#J4
doublet_removal_noapprox(sample = split_sample$J4, expected = 0.079, pK = 0.18) #pK obtained from plot in line above
...
#J15
doublet_removal_noapprox(sample = split_sample$J15, expected = 0.067, pK = 0.17) #pK obtained from plot in line above
