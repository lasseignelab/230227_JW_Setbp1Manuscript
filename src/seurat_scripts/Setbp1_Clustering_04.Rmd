...
jpeg(file = here("results/ts_results/seurat/kidneyint_clustree.jpeg"))
...
jpeg(file = here("results/ts_results/cerebralint_clustree.jpeg"))
...
DimPlot(cerebral_int, reduction = "umap_harmony", group.by = "RNA_snn_res.0.7") +
  ggtitle("leiden_0.7")
DimPlot(cerebral_int, reduction = "umap_harmony", group.by = "RNA_snn_res.0.8") +
  ggtitle("leiden_0.8")
...
DimPlot(cerebral_int, reduction = "umap_harmony", group.by = "RNA_snn_res.1") +
  ggtitle("leiden_1")
DimPlot(cerebral_int, reduction = "umap_harmony", group.by = "RNA_snn_res.1.5") +
  ggtitle("leiden_1.5")
```
