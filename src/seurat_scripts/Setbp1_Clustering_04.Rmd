...
png(file = here("results/seurat/Clustering_04/kidneyint_clustree.jpeg"),
    width = 1000,
    height = 1000)
clustree(kidney_int@meta.data, prefix = "RNA_snn_res.")
dev.off()

save(kidney_int_mousecell, file = here("data/kidney_leiden.Rdata"))
...
png(file = here("results/seurat/Clustering_04/cerebralint_clustree.jpeg"),
    width = 1000,
    height = 1000)
...
```{r}
# harmony
png(file = here("results/seurat/Clustering_04/kidneyint_res.jpeg"),
    width = 1000,
    height = 1000)
...
png(file = here("results/seurat/Clustering_04/cerebralint_res.jpeg"),
    width = 1000,
    height = 1000)
DimPlot(cerebral_int, reduction = "umap_harmony", group.by = "RNA_snn_res.0.9") +
  ggtitle("leiden_0.9")
dev.off()
```
...
#### plot the clustering
```{r}
png(file = here("results/seurat/Clustering_04/cerebralint_UMAP_postharmony.jpeg"),
    width = 2000,
    height = 1000)
plot_grid(ncol = 3, 
          DimPlot(kidney_int,
...
png(file = here("results/seurat/Clustering_04/kidneyint_UMAP_postharmony.jpeg"),
    width = 2000,
    height = 1000)
plot_grid(ncol = 3, 
