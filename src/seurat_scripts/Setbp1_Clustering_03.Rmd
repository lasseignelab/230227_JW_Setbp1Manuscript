...
png(file = here("results/seurat/Clustering_03/kidneyint_clustree.jpeg"),
    width = 1000,
    height = 2000)
...
png(file = here("results/seurat/Clustering_03/cerebralint_clustree.jpeg"),
    width = 1000,
    height = 2000)
...
```{r}
# harmony
png(file = here("results/seurat/Clustering_03/kidneyint_res_preSoup.jpeg"),
    width = 1000,
    height = 1000)
...
png(file = here("results/seurat/Clustering_03/cerebralint_res.jpeg"),
    width = 1000,
    height = 1000)
...
#### plot the clustering
```{r}
png(file = here("results/seurat/Clustering_03/cerebralint_UMAP_postharmony.jpeg"),
    width = 2000,
    height = 1000)
plot_grid(ncol = 3, 
          DimPlot(kidney_int,
...
png(file = here("results/seurat/Clustering_03/kidneyint_UMAP_postharmony.jpeg"),
    width = 2000,
    height = 1000)
plot_grid(ncol = 3, 
