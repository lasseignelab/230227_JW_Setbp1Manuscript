...
```{r}
final_cerebral_features <- c("Slc17a7", "Pcp4", "Synpr", "Gad1", "Hapln2", "Olig2", "Pdgfra", "Aqp4", "Gja1", "Slc1a3", "Cx3cr1", "Csf1r", "Dock8", "Vtn", "Nr4a2", "Ptgds", "Ryr3", "Opalin", "Bcn2")
...
FeaturePlot(cerebral_int, features = c("Slc17a7", "Pcp4"), label = TRUE, reduction = "umap_harmony")) #cluster 19 is excitatory neurons
dev.off()
```
...
FeaturePlot(cerebral_int, features = c("Ntng1", "Cdh8"), label = TRUE, reduction = "umap_harmony")) #looking at top markers from top 25, cluster 31 is excitatory neurons
dev.off()
```
...
FeaturePlot(cerebral_int, features = c("Slc1a3", "Gja1", "Aqp4"), label = TRUE, reduction = "umap_harmony")) #cluster 28 is astrocytes
dev.off()
...
FeaturePlot(cerebral_int, features = c("Bnc2"), label = TRUE, reduction = "umap_harmony")) #cluster 35 is fibroblasts
dev.off()
```
...
png(file = here("results/seurat/CellTypes_05/cortex_nuclei_prop.png"),
    width = 1000,
    height = 1000)
p7
dev.off()
