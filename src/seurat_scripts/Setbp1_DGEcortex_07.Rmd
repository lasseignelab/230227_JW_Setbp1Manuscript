...
png(
  file = here("results/seurat/DGE_07/Setbp1_expression_cortex.png"),
  width = 1000,
  height = 1000
)
...
```{r}
write.csv(astrocytes_het, here("results/seurat/DGE_07/DEG_astrocytes.csv"), row.names = FALSE)
write.csv(excitatory.neurons_het, here("results/seurat/DGE_07/DEG_excitatory.neurons.csv"), row.names = FALSE)
write.csv(inhibitory.neurons_het, here("results/seurat/DGE_07/DEG_inhibitory.neurons.csv"), row.names = FALSE)
write.csv(microglia_het, here("results/seurat/DGE_07/DEG_microglia.csv"), row.names = FALSE)
write.csv(mural.cells_het, here("results/seurat/DGE_07/DEG_mural.cells.csv"), row.names = FALSE)
write.csv(oligodendrocytes_het, here("results/seurat/DGE_07/DEG_oligodendrocytes.csv"), row.names = FALSE)
write.csv(opcs_het, here("results/seurat/DGE_07/DEG_opcs.csv"), row.names = FALSE)
write.csv(fibroblasts_het, here("results/seurat/DGE_07/DEG_fibroblasts.csv"), row.names = FALSE)
```
...
write.csv(DEGs_cerebralcells, file = here("results/seurat/DGE_07/DEGs_cerebralcells.csv")) #written out once then commented out

DEGs_cerebralcells <- read.csv(here("results/seurat/DGE_07/DEGs_cerebralcells.csv"))
```
